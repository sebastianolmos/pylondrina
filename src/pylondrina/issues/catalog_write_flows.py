...
WRITE_FLOWS_ISSUES: dict[str, IssueSpec] = {
    ...
    "WRITE_FLOWS.IO.FLOWS_WRITE_FAILED": _err(
        ...
        "Falló la escritura de flows.parquet durante write_flows.",
        details_keys=("path", "artifact", "storage_format", "parquet_compression", "reason", "action"),
        defaults={"action": "abort"},
        exception="export",
    ),
    "WRITE_FLOWS.IO.FLOW_TO_TRIPS_WRITE_FAILED": _err(
        "WRITE_FLOWS.IO.FLOW_TO_TRIPS_WRITE_FAILED",
        "Falló la escritura de flow_to_trips.parquet durante write_flows.",
        details_keys=("path", "artifact", "storage_format", "parquet_compression", "reason", "action"),
        defaults={"action": "abort"},
        exception="export",
    ),
